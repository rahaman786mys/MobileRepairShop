...
import com.app.muzzutech.data.db.dao.CommonFaultDao;
import com.app.muzzutech.data.db.dao.CommonFaultDao_Impl;
import com.app.muzzutech.data.db.dao.CustomerDao;
import com.app.muzzutech.data.db.dao.CustomerDao_Impl;
import com.app.muzzutech.data.db.dao.DealerDao;
import com.app.muzzutech.data.db.dao.DealerDao_Impl;
import com.app.muzzutech.data.db.dao.RepairEntryDao;
import com.app.muzzutech.data.db.dao.RepairEntryDao_Impl;
import com.app.muzzutech.data.db.dao.SaleDao;
import com.app.muzzutech.data.db.dao.SaleDao_Impl;
import com.app.muzzutech.data.db.dao.ServiceManDao;
import com.app.muzzutech.data.db.dao.ServiceManDao_Impl;
import com.app.muzzutech.data.db.dao.SparePartPurchaseDao;
import com.app.muzzutech.data.db.dao.SparePartPurchaseDao_Impl;
import com.app.muzzutech.data.db.dao.SupplierDao;
import com.app.muzzutech.data.db.dao.SupplierDao_Impl;
import com.app.muzzutech.data.db.dao.UserProfileDao;
import com.app.muzzutech.data.db.dao.UserProfileDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(5) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoRepairEntries.equals(_existingRepairEntries)) {
          return new RoomOpenHelper.ValidationResult(false, "repair_entries(com.app.muzzutech.data.model.RepairEntry).\n"
                  + " Expected:\n" + _infoRepairEntries + "\n"
        ...
        if (!_infoServiceMen.equals(_existingServiceMen)) {
          return new RoomOpenHelper.ValidationResult(false, "service_men(com.app.muzzutech.data.model.ServiceMan).\n"
                  + " Expected:\n" + _infoServiceMen + "\n"
                  + " Found:\n" + _existingServiceMen);
        }
        ...
        if (!_infoSuppliers.equals(_existingSuppliers)) {
          return new RoomOpenHelper.ValidationResult(false, "suppliers(com.app.muzzutech.data.model.Supplier).\n"
                  + " Expected:\n" + _infoSuppliers + "\n"
                  + " Found:\n" + _existingSuppliers);
        }
        ...
        if (!_infoCommonFaults.equals(_existingCommonFaults)) {
          return new RoomOpenHelper.ValidationResult(false, "common_faults(com.app.muzzutech.data.model.CommonFault).\n"
                  + " Expected:\n" + _infoCommonFaults + "\n"
        ...
        if (!_infoSparePartPurchases.equals(_existingSparePartPurchases)) {
          return new RoomOpenHelper.ValidationResult(false, "spare_part_purchases(com.app.muzzutech.data.model.SparePartPurchase).\n"
        ...
        if (!_infoCustomers.equals(_existingCustomers)) {
          return new RoomOpenHelper.ValidationResult(false, "customers(com.app.muzzutech.data.model.Customer).\n"
                  + " Expected:\n" + _infoCustomers + "\n"
                  + " Found:\n" + _existingCustomers);
        }
        ...
        if (!_infoDealers.equals(_existingDealers)) {
          return new RoomOpenHelper.ValidationResult(false, "dealers(com.app.muzzutech.data.model.Dealer).\n"
                  + " Expected:\n" + _infoDealers + "\n"
                  + " Found:\n" + _existingDealers);
        }
        ...
        if (!_infoSales.equals(_existingSales)) {
          return new RoomOpenHelper.ValidationResult(false, "sales(com.app.muzzutech.data.model.Sale).\n"
                  + " Expected:\n" + _infoSales + "\n"
                  + " Found:\n" + _existingSales);
        }
        ...
        if (!_infoUserProfile.equals(_existingUserProfile)) {
          return new RoomOpenHelper.ValidationResult(false, "user_profile(com.app.muzzutech.data.model.UserProfile).\n"
                  + " Expected:\n" + _infoUserProfile + "\n"
